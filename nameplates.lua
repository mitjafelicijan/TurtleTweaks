    ...
    if Nameplates and Nameplates["enabled"] then
        ...
        for _, namePlate in ipairs(frames) do
            if IsNamePlateFrame(namePlate) then
                ...
                Level:SetPoint("BOTTOM", namePlate, "BOTTOM", (((nameplate["base"] / 2)) * scale),
                    ((nameplate["height"] / 2) * scale) - (12 * scale))
...
NameplatesUI = {}
NameplatesUI["enabled"] = nil
NameplatesUI["slider"] = nil

NameplatesUI.form = function(container, verticalOffset, horizontalOffset)
    ...
    -- Create the slider.
    NameplatesUI["slider"] = CreateFrame("Slider", "MySliderGlobalName", container, "OptionsSliderTemplate")
    NameplatesUI["slider"]:SetWidth(200)
